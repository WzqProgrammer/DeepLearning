...
class VGG16:
    ...
    def __init__(self, imgs):
        self.parameters = []  # 在类的初始化时加入全局列表，将需要共享的参数加载进来
        self.imgs = imgs
        self.conv_layers()
        self.fc_layers()
        self.probs = tf.nn.softmax(self.fc8)  # 输出每个属于类别的概率值
